...
package Vertical_Dashboard is
	...
	type Board_Type is array (1..Max_Row, 1..Max_Column) of Box;
	
	function Dashboard_Is_Full(Dashboard: in Board_Type) return Boolean;
	
	function Is_Column_Full(Dashboard: Board_Type; Column: Integer) return Boolean;
		
	procedure Put_Token(Dashboard: in out Board_Type; Column: in Integer; Player: in Integer; Winner: out Boolean);
